"""
Django settings for storagetest project.
...
SECRET_KEY = 'django-insecure-cov(l@)7s@4ly&xg36t@$kah612x-cuo+r0l9gtxub*2q66lv9'
...
WSGI_APPLICATION = 'storagetest.wsgi.application'
